...
/*Exercise #2:
Use two common table expressions and a COUNT() function in the SELECT statement of a query to
...
/*Exercise #3:
Does the result from the previous exercise change if you used the 
Common Table Expression (CTE) for the male employees' highest salaries in a FROM clause, 
as opposed to in a join?*/

-- with out giving on condition at the end
